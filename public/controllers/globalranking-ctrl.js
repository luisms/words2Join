angular.module("words2JoinAPP")
    ...
    .controller("globalranking-ctrl", function ($scope, $http, PagerService) {
        ...
        function setPage(page) {
            ...
            vm.pager = PagerService.GetPager(vm.ranking.length, page);

            // get current page of items
            vm.items = vm.ranking.slice(vm.pager.startIndex, vm.pager.endIndex + 1);
        }
    });
